...
This document is based on the [Node.js contribution guidelines](https://github.com/nodejs/io.js/blob/master/CONTRIBUTING.md)
...
The Gort project welcomes new contributors.
...
`git remote add contrib1 https://github.com/contrib1/gort`
